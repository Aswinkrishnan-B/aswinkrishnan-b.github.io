...
function onPlayerError(event) {
  ...
  const messages = {
    2: "പ്ലേലിസ്റ്റ് ID തെറ്റാണ്.",
    5: "ഈ വീഡിയോ പ്ലേ ചെയ്യാൻ കഴിയുന്നില്ല.",
    100: "പ്ലേലിസ്റ്റ് കണ്ടെത്താനായില്ല — സ്വകാര്യമോ ഡിലീറ്റ് ചെയ്തതോ ആകാം.",
    101: "ഈ വീഡിയോ എംബെഡ് ചെയ്യാൻ അനുവാദമില്ല.",
    150: "ഈ വീഡിയോ എംബെഡ് ചെയ്യാൻ അനുവാദമില്ല."
  };
  const el = document.getElementById("statusLine");
  if (el) el.textContent = messages[event.data] || `പിശക് (code ${event.data})`;
